...
#define HOMING_FEEDRATE {3000, 3000, 5, 0}  // set the homing speeds (mm/min)

// default settings

#define DEFAULT_AXIS_STEPS_PER_UNIT   {79.8076923077, 79.8076923077, 200 * 8/3, 760*1.1}  // default steps per unit for Ultimaker
